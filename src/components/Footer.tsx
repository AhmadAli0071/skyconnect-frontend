        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-600 hover:text-sky">Home</Link></li>
              <li><a href="/#services" className="text-gray-600 hover:text-sky">Services</a></li>
              <li><a href="/#packages" className="text-gray-600 hover:text-sky">Packages</a></li>
              <li><Link to="/all-packages" className="text-gray-600 hover:text-sky">All Packages</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <CallButton phoneNumber="+18669476817" className="w-full justify-center" />
              <div className="flex gap-4">
                <a href="https://www.facebook.com/yourpage" target="_blank" rel="noopener noreferrer"
                   className="w-10 h-10 rounded-full bg-gray-200 hover:bg-sky flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="text-gray-600 hover:text-white" viewBox="0 0 16 16">
                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                  </svg>
                </a>
                <a href="https://wa.me/18669476817" target="_blank" rel="noopener noreferrer"
                   className="w-10 h-10 rounded-full bg-gray-200 hover:bg-sky flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 448 512" className="text-gray-600 hover:text-white">
